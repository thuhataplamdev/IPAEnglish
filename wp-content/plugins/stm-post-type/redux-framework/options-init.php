...
function stm_load_theme_options() {
	...
	$layout         = ( ! empty( stm_get_layout() ) ) ? stm_get_layout() : 'default';
		...
		array(
			...
			'fields'  => array(
				...
				array(
					...
					'type'    => 'color',
					'title'   => __( 'Header Background Color', 'stm-post-type' ),
					'default' => '',
				),
				array(
	...
	Redux::setSection(
		$opt_name,
		array(
			'title'      => __( ' Mobile Header', 'stm-post-type' ),
			'desc'       => '',
			'icon'       => 'el-icon-user',
			'subsection' => true,
			'fields'     => array(
				array(
					'id'          => 'header_mobile_bg',
					'type'        => 'color',
					'title'       => __( 'Background Color', 'stm-post-type' ),
					'default'     => '',
					'transparent' => false,
				),
				array(
					'id'          => 'header_mobile_hamburger_bg',
					'type'        => 'color',
					'title'       => __( 'Hamburger Menu Icon Color', 'stm-post-type' ),
					'default'     => '',
					'transparent' => false,
				),
				array(
					'id'      => 'header_user_account_switch',
					'type'    => 'switch',
					'title'   => __( 'User Account Icon', 'stm-post-type' ),
					'default' => true,
				),
				array(
					'id'      => 'header_search_categories_switch',
					'type'    => 'switch',
					'title'   => __( ' Course Categories', 'stm-post-type' ),
					'default' => true,
				),
		...
		array(
			...
			'fields'  => array(
				...
				array(
					...
					'required' => array( array( 'top_bar_social', '=', true ) ),
					'options'  => array(
						'facebook'     => 'Facebook',
						'twitter'      => 'Twitter',
						'instagram'    => 'Instagram',
...
',
				...
				array(
					...
					'output'  => array(
						'color'            => '#footer_bottom, .widget_contacts ul li .text,
												...
												.widget_pages ul.style_1 li a .h6, #footer_bottom .widget_stm_recent_posts .widget_media .h6',
	...
	$copyright_fields = apply_filters(
		'masterstudy_copyright_fields',
		array(
			array(
				'id'      => 'footer_copyright',
				'type'    => 'switch',
			...
			array(
				...
				'default'  => __( 'Copyright &copy; <a target="_blank" href="https://stylemixthemes.com/masterstudy/">MasterStudy</a> Theme for WordPress by <a target="_blank" href="https://www.stylemixthemes.com/">StylemixThemes</a>', 'stm-post-type' ),
			),
			array(
