(function registerDmslmsRecentCoursesModule(windowObj) {
  if (!windowObj) {
    return;
  }

  var metadata = {
    name: 'masterstudy/recent-courses',
    d4Shortcode: 'dmslms_recent_courses',
    title: 'MS Recent Courses',
    titles: 'MS Recent Courses',
    moduleClassName: 'dmslms_recent_courses',
    moduleOrderClassName: 'dmslms_recent_courses',
    category: 'module',
    attributes: {
      module: {
        type: 'object',
      ...
      title: {
        type: 'object',
        selector: '{{selector}}',
        default: { innerContent: { desktop: { value: 'MS Recent Courses' } } },
        settings: {
          innerContent: {
          ...
          innerContent: {
            ...
            item: {
              ...
              component: {
                name: 'divi/select',
                type: 'field',
                props: { options: { '2': { label: '2' }, '3': { label: '3' }, '4': { label: '4' }, '6': { label: '6' }, '8': { label: '8' }, '12': { label: '12' } } }
              }
            }
          }
        }
      ...
      perRow: {
        type: 'object',
        default: { innerContent: { desktop: { value: '6' } } },
        settings: {
          innerContent: {
            groupType: 'group-item',
            item: {
              ...
              component: {
                name: 'divi/select',
                type: 'field',
                props: { options: { '2': { label: '2' }, '3': { label: '3' }, '4': { label: '4' }, '6': { label: '6' } } }
              }
            }
          }
        }
  ...
  var getEditRenderer = function getEditRenderer(React, ModuleContainer) {
    return function editRenderer(props) {
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'dmslms-recent-courses-d5-preview' },
