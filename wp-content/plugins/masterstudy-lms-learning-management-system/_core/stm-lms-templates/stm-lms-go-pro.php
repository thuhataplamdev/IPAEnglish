...
if ( $is_promotion ) {
	...
	$freemius_info['plan']['licenses_1']->lifetime_price    = 249;
}
	...
	<section class="stm_go_pro">
		<div class="container">
			<div class="stm_go_pro_plugin">
				...
				<?php if ( $is_promotion ) : ?>
				<div class="stm-discount"><a href="https://stylemixthemes.com/wordpress-lms-plugin/pricing/?utm_source=wpadmin&utm_medium=push&utm_campaign=masterstudy&utm_content=gopro&utm_term=summersale2026&plugin_coupon=MIDSUMMER26" target="_blank"></a></div>
				<?php endif; ?>
			</div>
						...
						<div class="col-md-4">
							<div class="stm_plan <?php echo esc_attr( $plan->data['classname'] ); ?>">
								...
								if ( 'stm-lms-go-pro' === $_GET['page'] ) {
									...
									if ( $is_promotion ) {
										$annual_url = $annual_url .= '&plugin_coupon=MIDSUMMER26';
									}
