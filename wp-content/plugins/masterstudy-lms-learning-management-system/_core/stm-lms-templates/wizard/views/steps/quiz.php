<div class="stm_lms_splash_wizard__content_tab"
	v-if="active_step === 'quiz'">
	<h4>
		<?php esc_html_e( 'Quiz page style', 'masterstudy-lms-learning-management-system' ); ?>
	</h4>
	<hr/>
	<div class="stm_lms_splash_wizard__field stm_lms_splash_wizard__field_image_radio quiz_style">
		...
		STM_LMS_Templates::show_lms_template(
			...
			array(
				'title' => esc_html__( 'Page style', 'masterstudy-lms-learning-management-system' ),
				'desc'  => esc_html__( 'Choose how to show quizzes: one question per page or all questions on one page', 'masterstudy-lms-learning-management-system' ),
			)
		);
		?>
