			...
			<div class="ms_lms_courses_card_item_info">
				...
				if ( ! empty( $card_data['show_excerpt'] ) && ! empty( $course['post_excerpt'] ) ) {
					...
					<div class="ms_lms_courses_card_item_info_excerpt">
						<?php echo wp_kses_post( stm_lms_minimize_word( strip_shortcodes( $course['post_excerpt'] ), 100, '...' ) ); ?>
					</div>
					<?php
				}
				...
				<?php
				if ( ! empty( $card_data['show_slots'] ) && ! ( 'empty' === $meta_slots['card_slot_1'] && 'empty' === $meta_slots['card_slot_2'] && 'empty' === $meta_slots['card_slot_3'] ) ) {
					?>
				...
				<div class="ms_lms_courses_card_item_info_price_preview_wrapper">
					<a href="<?php echo esc_url( $course['url'] ); ?>" class="ms_lms_courses_card_item_info_price_preview">
						<span><?php esc_html_e( 'Start Learning', 'masterstudy-lms-learning-management-system' ); ?></span>
					</a>
				</div>
			</div>
		</div>
