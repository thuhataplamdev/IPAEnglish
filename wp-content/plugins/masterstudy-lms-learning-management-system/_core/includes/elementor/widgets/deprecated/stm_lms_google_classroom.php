...
class StmLmsGoogleClassroom extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'google_classroom_editor', STM_LMS_URL . 'assets/css/parts/admin/elementor_preview.css', array(), MS_LMS_VERSION, false );
		wp_register_style( 'google_classroom_module', STM_LMS_URL . 'assets/css/parts/google_classroom/module.css', array(), MS_LMS_VERSION, false );
	}
	...
	public function get_style_depends() {
		return array( 'google_classroom_module', 'google_classroom_editor' );
	}
