...
class StmLmsRecentCourses extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'recent_courses_style_1', STM_LMS_URL . 'assets/css/vc_modules/recent_courses/style_1.css', array(), MS_LMS_VERSION, false );
		wp_register_style( 'recent_courses_style_2', STM_LMS_URL . 'assets/css/vc_modules/recent_courses/style_2.css', array(), MS_LMS_VERSION, false );
	}

	public function get_style_depends() {
		return array( 'recent_courses_style_1', 'recent_courses_style_2' );
	}
