...
class MsLmsCourseEnrolled extends Widget_Base {

	public function get_name() {
		return 'ms_lms_course_enrolled';
	}

	public function get_title() {
		return esc_html__( 'Enrolled', 'masterstudy-lms-learning-management-system' );
	}

	public function get_icon() {
		return 'stmlms-enrolled-icon lms-course-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .masterstudy-single-course-enrolled__title',
			)
		);
		$this->add_control(
			'title_color',
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .masterstudy-single-course-enrolled__title' => 'color: {{VALUE}}',
				),
			)
		);
		$this->end_controls_section();
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .masterstudy-single-course-enrolled__item',
			)
		);
		$this->add_control(
			'color',
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .masterstudy-single-course-enrolled__item' => 'color: {{VALUE}}',
				),
			)
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} .masterstudy-single-course-enrolled__icon::before' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .masterstudy-single-course-enrolled__icon::before' => 'color: {{VALUE}}',
				),
			)
		);
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} .masterstudy-single-course-enrolled__icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
			)
		);
		$this->end_controls_section();
