...
class MsLmsCoursePriceInfo extends Widget_Base {

	public function get_name() {
		return 'ms_lms_course_price_info';
	}

	public function get_title() {
		return esc_html__( 'Price info', 'masterstudy-lms-learning-management-system' );
	}

	public function get_icon() {
		return 'stmlms-course-price lms-course-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .masterstudy-single-course-price-info',
			)
		);
		$this->add_control(
			'color',
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .masterstudy-single-course-price-info' => 'color: {{VALUE}}',
				),
			)
		);
		$this->end_controls_section();
