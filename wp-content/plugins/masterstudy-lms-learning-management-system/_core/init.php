...
define( 'STM_LMS_VERSION', '3.7.48' );
define( 'STM_LMS_DB_VERSION', '3.7.6' );
...
require_once STM_LMS_PATH . '/settings/custom_fields/taxes/main.php';
require_once STM_LMS_PATH . '/settings/custom_fields/search-select/main.php';
require_once STM_LMS_PATH . '/settings/custom_fields/button-links/main.php';
