...
require_once STM_LMS_PATH . '/lms/asset-helpers.php';
require_once STM_LMS_PATH . '/lms/countries.php';
...
require_once STM_LMS_PATH . '/lms/classes/email_free_triggers.php';
