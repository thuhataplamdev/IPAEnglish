				...
				'credentials' => array(
					...
					'fields' => array(
						'locked'       => array(
							...
							'description' => esc_html__( 'Enable this option so that only students who are signed in will see the Google Classroom code', 'masterstudy-lms-learning-management-system-pro' ),
							'value'       => false,
						),
						'enable_popup' => array(
							'type'        => 'checkbox',
							'label'       => esc_html__( 'Enable popup', 'masterstudy-lms-learning-management-system-pro' ),
							'description' => esc_html__( 'Activate this setting to display a popup for Google Classroom', 'masterstudy-lms-learning-management-system-pro' ),
						),
						'popup_title'  => array(
							'type'        => 'text',
							'label'       => esc_html__( 'Popup Title', 'masterstudy-lms-learning-management-system-pro' ),
							'description' => esc_html__( 'Set the title of the popup', 'masterstudy-lms-learning-management-system-pro' ),
							'dependency'  => array(
								'key'   => 'enable_popup',
								'value' => 'not_empty',
							),
						...
						'popup_editor' => array(
							...
							'description' => esc_html__( 'Provide content for the popup using the popup editor', 'masterstudy-lms-learning-management-system-pro' ),
							'dependency'  => array(
								'key'   => 'enable_popup',
								'value' => 'not_empty',
							),
						...
						'popup_image'  => array(
							...
							'description' => esc_html__( 'Add an image to the popup', 'masterstudy-lms-learning-management-system-pro' ),
							'dependency'  => array(
								'key'   => 'enable_popup',
								'value' => 'not_empty',
							),
						...
						'popup_link'   => array(
							'type'        => 'text',
							'label'       => esc_html__( 'Google Classrooms page', 'masterstudy-lms-learning-management-system-pro' ),
							'description' => esc_html__( 'Put the page URL with Google classrooms', 'masterstudy-lms-learning-management-system-pro' ),
							'dependency'  => array(
								'key'   => 'enable_popup',
								'value' => 'not_empty',
							),
