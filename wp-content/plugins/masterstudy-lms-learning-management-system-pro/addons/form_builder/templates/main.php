			...
			<div class="field-info">
				...
				<div class="field-settings" v-if="typeof forms[currentForm]['fields'][currentField] !== 'undefined'">
					...
					<div class="field-setting">
						<label>
							<span class="field-title">
								<?php esc_html_e( 'Field ID', 'masterstudy-lms-learning-management-system-pro' ); ?>
								<span class="tooltip-wrap">
									<i class="fas fa-info-circle"></i>
									<span class="field-tooltip"><?php esc_html_e( 'Ensure each form field has a unique ID to prevent bugs', 'masterstudy-lms-learning-management-system-pro' ); ?></span>
								</span>
							</span>
