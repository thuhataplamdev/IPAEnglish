...
class STM_LMS_Testing_Online {
	...
	public static function online_testing_info() {
		...
		<blockquote class="stm_lms_guide">
			<h4>
				<i class="stmlms-pointer-right"></i><?php esc_html_e( 'How to use', 'masterstudy-lms-learning-management-system-pro' ); ?>
			</h4>
	...
	public static function shortcode( $atts ) {
		...
		return STM_LMS_Templates::load_lms_template( 'global/online-testing/main', array( 'item_id' => $item_id ) );
	}
