	...
	vc_map(
		array(
			...
			'params'   => array(
				...
				array(
					'type'        => 'dropdown',
					'heading'     => __( 'Box Align', 'masterstudy' ),
		...
		array(
			...
			'params'   => array(
				...
				array(
					...
					'description' => __( 'Number Only', 'masterstudy' ),
				...
				array(
					...
					'param_name'  => 'icon_width',
					'value'       => '',
					'description' => __( 'Enter icon width in px', 'masterstudy' ),
				),
				array(
					'type'        => 'textfield',
					'heading'     => __( 'Icon Height', 'masterstudy' ),
				...
				array(
					...
					'description' => __( 'Icon Background Color', 'masterstudy' ),
				),
				array(
					'type'       => 'textfield',
...
<span class='st_googleplus_large' displayText=''></span>",
	...
	vc_map(
		array(
			'name'      => __( 'Offline Course Lessons', 'masterstudy' ),
		...
		array(
			...
			'params'   => array(
				...
				array(
					...
					'param_name' => 'badge',
					'value'      => array(
						__( 'Choose Badge', 'masterstudy' ) => 'no_badge',
						__( 'Test', 'masterstudy' )     => 'test',
						__( 'Video', 'masterstudy' )    => 'video',
						__( 'Exam', 'masterstudy' )     => 'exam',
						__( 'Quiz', 'masterstudy' )     => 'quiz',
						__( 'Lecture', 'masterstudy' )  => 'lecture',
						__( 'Seminar', 'masterstudy' )  => 'seminar',
						__( 'Free', 'masterstudy' )     => 'free',
						__( 'Practice', 'masterstudy' ) => 'practice',
						__( 'Exercise', 'masterstudy' ) => 'exercise',
						__( 'Activity', 'masterstudy' ) => 'activity',
					),
				),
				array(
					'type'        => 'textfield',
		...
		array(
			...
			'params'   => array(
				...
				array(
					...
					'description' => __( 'Only numbers', 'masterstudy' ),
					'param_name'  => 'per_page',
				),
				array(
					'type'       => 'css_editor',
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_Stm_Course_Lesson extends WPBakeryShortCode {
		public function __construct( $settings ) {
			...
			add_filter( 'do_shortcode_tag', array( $this, 'stm_shortcode_filter' ), 10, 2 );
		}

		public function stm_shortcode_filter( $output, $tag ) {
			return 'stm_course_lesson' === $tag ? do_shortcode( $output ) : $output;
		}
	}
...
function stm_construct_icons( $fonts ) {
	...
	$fonts['Font Awesome 6'] = stm_new_fa_icons();
