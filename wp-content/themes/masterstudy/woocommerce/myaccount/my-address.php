 ...
 * My Addresses
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/myaccount/v1/my-address.php.
 *
...
<p class="myaccount_address">
	<?php echo wp_kses( apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used on the checkout page by default.', 'masterstudy' ) ) ); ?>
</p>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 address">
		<header class="title">
			<h3><?php echo esc_html( sanitize_text_field( $title ) ); ?></h3>
		</header>
		<address>
			<?php
			...
			<footer>
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="button edit edit-billing-address"><?php esc_html_e( 'Edit', 'masterstudy' ); ?></a>
			</footer>
	</div>
