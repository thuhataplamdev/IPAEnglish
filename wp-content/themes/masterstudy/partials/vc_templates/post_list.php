...
$rand_class = 'post_list_' . wp_rand( 0, 9999 );
$query      = new WP_Query(
	array(
	...
	<div class="post_list_main_section_wrapper <?php echo esc_attr( $rand_class ); ?>">
		<div class="row">
			...
			while ( $query->have_posts() ) :
						...
						<?php if ( has_post_thumbnail() ) : ?>
							<div class="post_list_featured_image">
								<a href="<?php the_permalink(); ?>" title="<?php esc_attr_e( 'View post details', 'masterstudy' ); ?>">
									<?php echo wp_kses_post( masterstudy_lazyload_image( get_the_post_thumbnail( get_the_ID(), 'large', array( 'class' => 'img-responsive' ) ) ) ); ?>
								</a>
							</div>
						<?php endif; ?>
						<div class="row">
							...
							<div class="<?php echo $post_list_show_date ? 'col-md-9 col-sm-8 col-xs-12' : 'col-md-12'; ?>">
								<div class="post_list_inner_content_unit <?php echo $post_list_show_date ? 'post_list_inner_content_unit_left' : ''; ?>">
										...
										if ( ! empty( $post_list_item_categories ) ) :
											...
											<div class="post_list_cats">
												...
												<?php foreach ( $post_list_item_categories as $post_list_single_cat ) : ?>
													...
													<a href="<?php echo esc_url( get_term_link( $post_list_cat ) ); ?>"><?php echo esc_html( sanitize_text_field( $post_list_cat->name ) ); ?></a><span class="post_list_divider">,</span>
												<?php endforeach; ?>
											</div>
										<?php endif; ?>
									<?php endif; ?>
										...
										if ( $posttags ) :
											...
											<div class="post_list_item_tags">
												...
												<?php foreach ( $posttags as $tag_object ) : ?>
													<a href="<?php echo esc_url( get_tag_link( $tag_object->term_id ) ); ?>"><?php echo esc_html( sanitize_text_field( $tag_object->name ) ); ?></a><span class="post_list_divider">,</span>
												<?php endforeach; ?>
											</div>
										<?php endif; ?>
									<?php endif; ?>
				...
				<?php if ( 0 === $current_list_item % $post_list_per_row ) : ?>
